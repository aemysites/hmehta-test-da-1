...
## Environments
- Preview: https://main--hmehta-test-da-1--aemysites.aem.page/
- Live: https://main--hmehta-test-da-1--aemysites.aem.live/
- Block Library: https://main--hmehta-test-da-1--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `hmehta-test-da-1` directory in your favorite IDE and start coding :)
